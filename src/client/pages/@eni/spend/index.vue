...
const getList = async () => {
  try {
    ...
    const data = await useAPI('spend/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('spend/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('spend/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('spend/admin/del', { _id })
