<template>
  <UiContent title="Limited Event Lucky Money" sub="Quản lý rút may mắn">
    <UiFlex class="mb-4">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('limitedevent/luckymoney/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('limitedevent/luckymoney/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('limitedevent/luckymoney/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('limitedevent/luckymoney/admin/del', { _id })
