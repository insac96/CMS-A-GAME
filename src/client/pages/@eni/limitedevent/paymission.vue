<template>
  <UiContent title="Limited Event Payment" sub="Quản lý mốc thưởng liên nạp">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('limitedevent/paymission/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('limitedevent/paymission/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('limitedevent/paymission/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const giftAction = async () => {
  try {
    ...
    await useAPI('limitedevent/paymission/admin/editGift', JSON.parse(JSON.stringify(stateGift.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('limitedevent/paymission/admin/del', { _id })
