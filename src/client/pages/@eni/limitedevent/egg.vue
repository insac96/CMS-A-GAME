...
const submit = async () => {
  try {
    loading.value = true
    await useAPI('limitedevent/egg/admin/update', JSON.parse(JSON.stringify(state.value)))
...
const reset = async () => {
  try {
    loading.value = true
    await useAPI('limitedevent/egg/admin/reset', JSON.parse(JSON.stringify(stateReset.value)))
    loading.value = false
  }
  catch(e){
    loading.value = false
...
const getConfig = async () => {
  const data = await useAPI('limitedevent/egg/admin/get')
