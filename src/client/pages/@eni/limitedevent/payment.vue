...
const getList = async () => {
  try {
    ...
    const data = await useAPI('limitedevent/payment/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('limitedevent/payment/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('limitedevent/payment/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const giftAction = async () => {
  try {
    ...
    await useAPI('limitedevent/payment/admin/editGift', JSON.parse(JSON.stringify(stateGift.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('limitedevent/payment/admin/del', { _id })
