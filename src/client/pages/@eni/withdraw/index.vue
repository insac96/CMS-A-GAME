...
const successAction = async () => {
  try {
    ...
    await useAPI('withdraw/admin/verify', JSON.parse(JSON.stringify(stateSuccess.value)))
...
const refuseAction = async () => {
  try {
    ...
    await useAPI('withdraw/admin/verify', JSON.parse(JSON.stringify(stateRefuse.value)))
