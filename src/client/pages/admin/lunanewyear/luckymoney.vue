<template>
  <UiContent title="Lunar Lucky Money" sub="Quản lý bao lì xì tết may mắn">
    <UiFlex class="mb-4">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('lunanewyear/luckymoney/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('lunanewyear/luckymoney/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('lunanewyear/luckymoney/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('lunanewyear/luckymoney/admin/del', { _id })
