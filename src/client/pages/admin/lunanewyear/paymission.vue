<template>
  <UiContent title="Lunar Payment" sub="Quản lý mốc thưởng sự kiện liên nạp tết">
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('lunanewyear/paymission/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('lunanewyear/paymission/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('lunanewyear/paymission/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const giftAction = async () => {
  try {
    ...
    await useAPI('lunanewyear/paymission/admin/editGift', JSON.parse(JSON.stringify(stateGift.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('lunanewyear/paymission/admin/del', { _id })
