...
const actions = (row) => [
  ...
  [{
    ...
    click: async () => {
      try {
        const content = await useAPI('news/admin/content/get', { _id: row._id })
...
const getList = async () => {
  try {
    ...
    const data = await useAPI('news/admin/list', JSON.parse(JSON.stringify(page.value)))
...
const addAction = async () => {
  try {
    ...
    await useAPI('news/admin/add', JSON.parse(JSON.stringify(stateAdd.value)))
...
const editAction = async () => {
  try {
    ...
    await useAPI('news/admin/edit', JSON.parse(JSON.stringify(stateEdit.value)))
...
const delAction = async (_id) => {
  try {
    ...
    await useAPI('news/admin/del', { _id })
...
const contentAction = async () => {
  try {
    ...
    await useAPI('news/admin/content/edit', JSON.parse(JSON.stringify(stateContent.value)))
